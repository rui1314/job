...
<![endif]-->
<script src="theme/default/js/conv.js" type="text/javascript"></script>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="work/add" method="post" id="jobForm">
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td width="85">职位类别</td>
										<td>
											<input type="hidden" id="positionType" value="" name="work.type"> 
									...
									<tr>
										...
										<td>职位名称</td>
										<td>
											<input type="text" placeholder="请输入职位名称，如：产品经理" value="" name="work.name" id="positionName">
										</td>
									</tr>
									<tr>
										<td></td>
										<td>所属部门</td>
										<td>
											<input type="text" placeholder="请输入所属部门" value="" name="work.department" id="department">
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td>
											<ul class="profile_radio clearfix reset">
												<li>全职<em></em> <input type="radio" name="work.nature"
													value="全职">
												</li>
												<li>兼职<em></em> <input type="radio" name="work.nature"
													value="兼职">
												</li>
												<li>实习<em></em> <input type="radio" name="work.nature"
													value="实习">
												</li>
											</ul>
										</td>
									...
									<tr>
										...
										<td>工作城市</td>
										<td>
											<input type="text" placeholder="请输入工作城市，如：北京" value="" name="work.city" id="workAddress">
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td width="85">工作经验</td>
										<td>
											<input type="hidden" id="experience" value="" name="work.workExp"> 
									...
									<tr>
										...
										<!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
										<td>
											<input type="hidden" id="education" value="" name="work.education"> 
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td width="85">职位诱惑</td>
										<td>
											<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="work.advantage" class="input_520" id="positionAdvantage">
										</td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										...
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
											...
											<textarea name="work.describe" id="positionDetail"
												class="tinymce" aria-hidden="true"></textarea>
										</td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>工作地址</td>
										<td>
											<input type="text" placeholder="请输入详细的工作地址" value="" name="work.address" class="input_520" id="positionAddress">
										</td>
									</tr>
								</tbody>
							</table>

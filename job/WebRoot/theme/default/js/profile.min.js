...
$(function() {
    ...
    $("#profileForm").validate({
        ...
        submitHandler: function(a) {
        	$("#profileForm .btn_profile_cancel").click();
        	a.submit();
        }
    }),
    ...
    $(".editExp").click(function(){
    	var li = $(this).parent();
    	li.hide();
    	var expId = li.find("#expId").val(),
    	expName = li.find("#expName").val(),
    	startYear = li.find("#startYear").val(),
    	startMonth = li.find("#startMonth").val(),
    	endYear = li.find("#endYear").val(),
    	endMonth = li.find("#endMonth").val(),
    	expPosition = li.find("#expPosition").val();
    	$(".experienceShow .experienceForm").find("input[name='exp.id']").val(expId);
    	$(".experienceShow .experienceForm").find("input[name='exp.name']").val(expName);
    	$(".experienceShow .experienceForm").find("input[name='exp.position']").val(expPosition);
    	$(".experienceShow .experienceForm").find("input[name='exp.companyYearStart']").val(startYear);
    	$(".experienceShow .experienceForm").find("input[name='exp.companyMonthStart']").val(startMonth);
    	$(".experienceShow .experienceForm").find("input[name='exp.companyYearEnd']").val(endYear);
    	$(".experienceShow .experienceForm").find("input[name='exp.companyMonthEnd']").val(endMonth);
    	selectYear("companyYearStart",startYear);
    	selectYear("companyMonthStart",startMonth);
    	selectYear("companyYearEnd",endYear);
    	selectYear("companyMonthEnd",endMonth);
    	
    	$(".experienceShow .experienceForm").show();
    });
    
    $(".delExp").click(function(){
    	var expId = $(this).attr("expId");
    	window.location.href="resume/removeExp?exp.id="+expId;
    });
    ...
    $(".educationalForm").each(function() {
        $(this).validate({
            groups: {
                schoolYear: "companyYearStart companyYearEnd"
            },
            rules: {
                "edu.name": {
                    required: !0,
    ...
    $(".edit_education").click(function(){
    	var li = $(this).parent();
    	li.hide();
    	var eduId = li.find("#eduId").val(),
    	eduName = li.find("#eduName").val(),
    	eduMajor = li.find("#eduMajor").val(),
    	eduEducation = li.find("#eduEducation").val(),
    	eduBeginYear = li.find("#eduBeginYear").val(),
    	eduEndYear = li.find("#eduEndYear").val();
    	
    	$(".educationalShow .educationalForm").find("input[name='edu.id']").val(eduId);
    	$(".educationalShow .educationalForm").find("input[name='edu.name']").val(eduName);
    	$(".educationalShow .educationalForm").find("input[name='edu.major']").val(eduMajor);
    	$(".educationalShow .educationalForm").find("input[name='edu.education']").val(eduEducation);
    	$(".educationalShow .educationalForm").find("input[name='companyYearStart']").val(eduBeginYear);
    	$(".educationalShow .educationalForm").find("input[name='companyYearEnd']").val(eduEndYear);
    	selectYear("degree",eduEducation);
    	selectYear("schoolYearStart",eduBeginYear);
    	selectYear("schoolYearEnd",eduEndYear);
    	
    	$(".educationalShow .educationalForm").show();
    }),
    g = {
        obj: $("#selfDescription"),
